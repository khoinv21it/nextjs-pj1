                ...
                <div className={`${styles.user_options_container}`}>
                    <div className={`${styles.user_options_text}`}>
                        <div className={`${styles.user_options_unregistered}`}>
                            <h2 className={`${styles.user_unregistered_title}`}>Dont have an account?</h2>
                            ...
                            <button className={`${styles.user_unregistered_signup}`} id="signup-button">
                                Sign up
                            </button>
                        </div>
                        <div className={`${styles.user_options_registered}`} >
                            ...
                            <button className={`${styles.user_registered_login}`} id="login-button">
                                Login
                            </button>
                        </div>
                    </div>
                    <div className={`${styles.user_options_forms}`} id="user_options-forms">
                        <div className={`${styles.user_forms_login}`} >
                            ...
                            <form className={`${styles.forms_form}`} >
                                ...
                                <div className={`${styles.forms_buttons}`}>
                                    <button type="button" className={`${styles.forms_buttons_forgot}`}>
                                        Forgot password?
                                    </button>
                                    <input
                                        type="submit"
